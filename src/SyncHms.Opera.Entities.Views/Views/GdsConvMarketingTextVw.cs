...
public partial class GdsConvMarketingTextVw
{
    ...
    public string? ResortChainDisp { get; set; }

	public static void OnModelCreating(ModelBuilder modelBuilder, ISet<Type> types)
	{
		modelBuilder.Entity<GdsConvMarketingTextVw>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("GDS_CONV_MARKETING_TEXT_VW");
            ...
            entity.Property(e => e.ResortChainDisp)
                .HasColumnName("RESORT_CHAIN_DISP")
                .HasMaxLength(20)
                .IsUnicode(false);
