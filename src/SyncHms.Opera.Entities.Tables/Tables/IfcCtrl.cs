...
public partial class IfcCtrl
{
	...
	{
		modelBuilder.Entity<IfcCtrl>(entity =>
        {
            entity.HasKey(e => e.RowId)
                .HasName("IFC_CTRL_PK");

            entity.ToTable("IFC$_CTRL");

            entity.HasIndex(e => e.MachineId)
                .HasName("IFC_CTRL_MAC_IDX");

            entity.HasIndex(e => new { e.IfcType, e.Active })
                .HasName("IFC_CTRL_TYPE_ACTIVE");

            entity.HasIndex(e => new { e.Resort, e.ShellNum })
                .HasName("IFC_CTRL_RESORT_SH_IND");
