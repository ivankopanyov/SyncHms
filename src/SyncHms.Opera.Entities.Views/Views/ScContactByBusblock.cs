...
public partial class ScContactByBusblock
{
    ...
    public string? ConSrepCode { get; set; }
    public string? ConAddressType { get; set; }

	public static void OnModelCreating(ModelBuilder modelBuilder, ISet<Type> types)
	{
		modelBuilder.Entity<ScContactByBusblock>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("SC_CONTACT_BY_BUSBLOCK");
            ...
            entity.Property(e => e.ConSrepCode)
                .HasColumnName("CON_SREP_CODE")
                .IsUnicode(false);
