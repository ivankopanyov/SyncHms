...
public partial class PmsInteractiveTable
{
	...
	{
		modelBuilder.Entity<PmsInteractiveTable>(entity =>
        {
            entity.HasKey(e => e.Msgid)
                .HasName("SYS_C0037392");

            entity.ToTable("PMS_INTERACTIVE_TABLE");

            entity.HasIndex(e => e.TimeManagerInfo)
                .HasName("AQ$_PMS_INTERACTIVE_TABLE_T");

            entity.HasIndex(e => new { e.QName, e.State, e.EnqTime, e.StepNo, e.ChainNo, e.LocalOrderNo })
                .HasName("AQ$_PMS_INTERACTIVE_TABLE_I");
