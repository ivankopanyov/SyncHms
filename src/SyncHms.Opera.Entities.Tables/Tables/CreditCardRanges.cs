...
public partial class CreditCardRanges
{
	...
	{
		modelBuilder.Entity<CreditCardRanges>(entity =>
        {
            entity.HasNoKey();

            entity.ToTable("CREDIT_CARD_RANGES");

            entity.HasIndex(e => new { e.CcCard, e.CardnoFrom, e.CardnoTo })
                .HasName("CCR_IDX");

            entity.HasIndex(e => new { e.Resort, e.PaymentMethod, e.CcCard, e.CardnoFrom, e.CardnoTo })
                .HasName("CCR_UK")
                .IsUnique();
