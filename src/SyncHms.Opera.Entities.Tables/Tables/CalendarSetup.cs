...
public partial class CalendarSetup
{
	...
	{
		modelBuilder.Entity<CalendarSetup>(entity =>
        {
            entity.HasNoKey();

            entity.ToTable("CALENDAR$SETUP");

            entity.HasIndex(e => new { e.DateId, e.AllDates })
                .HasName("CALENDARSETUP_UK")
                .IsUnique();

            entity.HasIndex(e => new { e.DayId, e.DayEndDate })
                .HasName("CALENDARSETUP_IND1");
