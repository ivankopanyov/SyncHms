...
public partial class IfcActQueueTable
{
	...
	{
		modelBuilder.Entity<IfcActQueueTable>(entity =>
        {
            entity.HasKey(e => e.Msgid)
                .HasName("SYS_C0037420");

            entity.ToTable("IFC_ACT_QUEUE_TABLE");

            entity.HasIndex(e => e.TimeManagerInfo)
                .HasName("AQ$_IFC_ACT_QUEUE_TABLE_T");

            entity.HasIndex(e => new { e.QName, e.State, e.Corrid })
                .HasName("IFC_ACT_QUEUE_TABLE_IDX");

            entity.HasIndex(e => new { e.QName, e.State, e.EnqTime, e.StepNo, e.ChainNo, e.LocalOrderNo })
                .HasName("AQ$_IFC_ACT_QUEUE_TABLE_I");
