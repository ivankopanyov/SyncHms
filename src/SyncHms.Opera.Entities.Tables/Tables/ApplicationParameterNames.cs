...
public partial class ApplicationParameterNames
{
	...
	{
		modelBuilder.Entity<ApplicationParameterNames>(entity =>
        {
            entity.HasKey(e => e.ParameterName)
                .HasName("APP_PARAM_NAME_PK");

            entity.ToTable("APPLICATION_PARAMETER_NAMES");

            entity.HasIndex(e => e.ParameterDisplay)
                .HasName("APP_PARAM_NAME_UK1")
                .IsUnique();

            entity.HasIndex(e => new { e.ParameterGroup, e.ParameterName })
                .HasName("GROUP_PARAM_IDX");
