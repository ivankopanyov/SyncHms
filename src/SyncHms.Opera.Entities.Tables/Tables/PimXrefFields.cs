...
public partial class PimXrefFields
{
	...
	{
		modelBuilder.Entity<PimXrefFields>(entity =>
        {
            entity.HasKey(e => new { e.PimCode, e.OperaType, e.OperaTable, e.OperaField })
                .HasName("PXF_PK");

            entity.ToTable("PIM_XREF_FIELDS");
