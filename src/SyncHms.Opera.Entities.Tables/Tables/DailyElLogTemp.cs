...
public partial class DailyElLogTemp
{
	...
	{
		modelBuilder.Entity<DailyElLogTemp>(entity =>
        {
            entity.HasNoKey();

            entity.ToTable("DAILY_EL_LOG_TEMP");

            entity.HasIndex(e => new { e.ResvNameId, e.DataElement })
                .HasName("DAILY_EL_LOG_TEMP_IDX");
