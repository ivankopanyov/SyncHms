...
public partial class SourceProfStatDaily
{
	...
	{
		modelBuilder.Entity<SourceProfStatDaily>(entity =>
        {
            entity.HasNoKey();

            entity.ToTable("SOURCE_PROF_STAT_DAILY");

            entity.HasIndex(e => new { e.NameId, e.Resort, e.RoomType, e.BusinessDate, e.BlockYn })
                .HasName("SOURCE_PROF_STAT_DAILY_IND1")
                .IsUnique();

            entity.HasIndex(e => new { e.Resort, e.BusinessDate, e.NameId, e.RoomType, e.BlockYn })
                .HasName("SOURCE_PROF_STAT_DAILY_UK")
                .IsUnique();
