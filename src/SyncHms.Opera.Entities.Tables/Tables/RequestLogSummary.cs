...
public partial class RequestLogSummary
{
	...
	{
		modelBuilder.Entity<RequestLogSummary>(entity =>
        {
            entity.HasNoKey();

            entity.ToTable("REQUEST_LOG_SUMMARY");

            entity.HasIndex(e => new { e.ArrivalDate, e.RequestSourceType, e.RequestSource, e.RequestType, e.Resort })
                .HasName("REQUEST_LOG_SUMMARY_IDX2");

            entity.HasIndex(e => new { e.RequestDate, e.RequestSourceType, e.RequestSource, e.RequestType, e.Resort })
                .HasName("REQUEST_LOG_SUMMARY_IDX1");
