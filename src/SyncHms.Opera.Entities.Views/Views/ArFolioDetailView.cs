...
public partial class ArFolioDetailView
{
    public decimal? AccountCodeDetail { get; set; }
    public decimal? InvoiceNumberDetail { get; set; }
	...
	{
		modelBuilder.Entity<ArFolioDetailView>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("AR_FOLIO_DETAIL_VIEW");

            entity.Property(e => e.AccountCodeDetail)
                .HasColumnName("ACCOUNT_CODE_DETAIL")
            ...
            entity.Property(e => e.InvoiceNumberDetail)
                .HasColumnName("INVOICE_NUMBER_DETAIL")
                .HasColumnType("NUMBER");
