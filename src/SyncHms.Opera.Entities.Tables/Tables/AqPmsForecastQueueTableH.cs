...
public partial class AqPmsForecastQueueTableH
{
	...
	{
		modelBuilder.Entity<AqPmsForecastQueueTableH>(entity =>
        {
            entity.HasKey(e => new { e.Msgid, e.Subscriber, e.Name, e.Address })
                .HasName("SYS_IOT_TOP_142016");

            entity.ToTable("AQ$_PMS_FORECAST_QUEUE_TABLE_H");
