...
public partial class ReservationFolioView
{
    public string? FolioType { get; set; }
    public decimal? Balance { get; set; }
    public decimal? GuestBilledBalance { get; set; }
	...
	{
		modelBuilder.Entity<ReservationFolioView>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("RESERVATION_FOLIO_VIEW");
            ...
            entity.Property(e => e.GuestBilledBalance)
                .HasColumnName("GUEST_BILLED_BALANCE")
                .HasColumnType("NUMBER");
