...
public partial class ObiAwCubeDefinition
{
	...
	{
		modelBuilder.Entity<ObiAwCubeDefinition>(entity =>
        {
            entity.HasKey(e => new { e.SchemaName, e.AwName, e.CubeName })
                .HasName("OBI_AW_CUBE_DEFINITION_PK");

            entity.ToTable("OBI_AW_CUBE_DEFINITION");
