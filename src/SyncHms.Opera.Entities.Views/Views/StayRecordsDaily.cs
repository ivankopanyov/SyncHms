...
public partial class StayRecordsDaily
{
    ...
    public decimal? DailyNights { get; set; }
    public decimal? DailyRoomRevenue { get; set; }
    public decimal? DailyFbRevenue { get; set; }
    public decimal? DailyOtherRevenue { get; set; }
    public decimal? DailyRoomRevenueTax { get; set; }
    public decimal? DailyFbRevenueTax { get; set; }
    public decimal? DailyOtherRevenueTax { get; set; }
    public DateTime? BusinessDate { get; set; }
    public string? RateCode { get; set; }

	public static void OnModelCreating(ModelBuilder modelBuilder, ISet<Type> types)
	{
		modelBuilder.Entity<StayRecordsDaily>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("STAY_RECORDS_DAILY");
            ...
            entity.Property(e => e.DailyFbRevenue)
                .HasColumnName("DAILY_FB_REVENUE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.DailyFbRevenueTax)
                .HasColumnName("DAILY_FB_REVENUE_TAX")
                .HasColumnType("NUMBER");

            entity.Property(e => e.DailyNights)
                .HasColumnName("DAILY_NIGHTS")
                .HasColumnType("NUMBER");

            entity.Property(e => e.DailyOtherRevenue)
                .HasColumnName("DAILY_OTHER_REVENUE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.DailyOtherRevenueTax)
                .HasColumnName("DAILY_OTHER_REVENUE_TAX")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.DailyRoomRevenueTax)
                .HasColumnName("DAILY_ROOM_REVENUE_TAX")
                .HasColumnType("NUMBER");
