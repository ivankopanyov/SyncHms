...
public partial class ExpFoliotaxSumm
{
    ...
    public decimal? Net10 { get; set; }
    public decimal? Net11 { get; set; }
    public decimal? Net12 { get; set; }
    public decimal? Net13 { get; set; }
    public decimal? Net14 { get; set; }
    public decimal? Net15 { get; set; }
    public decimal? Net16 { get; set; }
    public decimal? Net17 { get; set; }
    public decimal? Net18 { get; set; }
    public decimal? Net19 { get; set; }
    public decimal? Net20 { get; set; }
	...
	{
		modelBuilder.Entity<ExpFoliotaxSumm>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("EXP_FOLIOTAX_SUMM");
            ...
            entity.Property(e => e.Net10)
                .HasColumnName("NET10")
                .HasColumnType("NUMBER");

            entity.Property(e => e.Net11)
                .HasColumnName("NET11")
                .HasColumnType("NUMBER");

            entity.Property(e => e.Net12)
                .HasColumnName("NET12")
                .HasColumnType("NUMBER");

            entity.Property(e => e.Net13)
                .HasColumnName("NET13")
                .HasColumnType("NUMBER");

            entity.Property(e => e.Net14)
                .HasColumnName("NET14")
                .HasColumnType("NUMBER");

            entity.Property(e => e.Net15)
                .HasColumnName("NET15")
                .HasColumnType("NUMBER");

            entity.Property(e => e.Net16)
                .HasColumnName("NET16")
                .HasColumnType("NUMBER");

            entity.Property(e => e.Net17)
                .HasColumnName("NET17")
                .HasColumnType("NUMBER");

            entity.Property(e => e.Net18)
                .HasColumnName("NET18")
                .HasColumnType("NUMBER");

            entity.Property(e => e.Net19)
                .HasColumnName("NET19")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.Net5)
                .HasColumnName("NET5")
                .HasColumnType("NUMBER");

            entity.Property(e => e.Net6)
                .HasColumnName("NET6")
                .HasColumnType("NUMBER");

            entity.Property(e => e.Net7)
                .HasColumnName("NET7")
                .HasColumnType("NUMBER");

            entity.Property(e => e.Net8)
                .HasColumnName("NET8")
                .HasColumnType("NUMBER");

            entity.Property(e => e.Net9)
                .HasColumnName("NET9")
                .HasColumnType("NUMBER");
