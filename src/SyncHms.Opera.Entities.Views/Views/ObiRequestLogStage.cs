...
public partial class ObiRequestLogStage
{
    public string? TableName { get; set; }
    public DateTime? InsertDate { get; set; }
    public string? Resort { get; set; }
    public DateTime? RequestDateTrunc { get; set; }
	...
	{
		modelBuilder.Entity<ObiRequestLogStage>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("OBI_REQUEST_LOG_STAGE");
            ...
            entity.Property(e => e.RequestDateTrunc)
                .HasColumnName("REQUEST_DATE_TRUNC")
                .HasColumnType("DATE");
