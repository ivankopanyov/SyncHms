...
public partial class AqPmsForecastQueueTableT
{
	...
	{
		modelBuilder.Entity<AqPmsForecastQueueTableT>(entity =>
        {
            entity.HasKey(e => new { e.NextDate, e.TxnId, e.Msgid })
                .HasName("SYS_IOT_TOP_142014");

            entity.ToTable("AQ$_PMS_FORECAST_QUEUE_TABLE_T");
