...
public partial class ResortBookingStatus
{
	...
	{
		modelBuilder.Entity<ResortBookingStatus>(entity =>
        {
            entity.HasKey(e => new { e.ChainCode, e.Status })
                .HasName("BOOKING_STATUS_PK");

            entity.ToTable("RESORT_BOOKING_STATUS");
