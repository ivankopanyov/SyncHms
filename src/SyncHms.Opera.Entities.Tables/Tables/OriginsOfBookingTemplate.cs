...
public partial class OriginsOfBookingTemplate
{
	...
	{
		modelBuilder.Entity<OriginsOfBookingTemplate>(entity =>
        {
            entity.HasKey(e => new { e.ChainCode, e.SourceCode })
                .HasName("ORIGINS_OF_BOOKING_TEMPLAT_PK");

            entity.ToTable("ORIGINS_OF_BOOKING_TEMPLATE");
