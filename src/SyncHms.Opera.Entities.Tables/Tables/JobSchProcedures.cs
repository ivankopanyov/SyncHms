...
public partial class JobSchProcedures
{
	...
	{
		modelBuilder.Entity<JobSchProcedures>(entity =>
        {
            entity.HasKey(e => e.JobProcCode)
                .HasName("JSE_PK");

            entity.ToTable("JOB_SCH_PROCEDURES");

            entity.HasIndex(e => e.JobProcGroup)
                .HasName("JOB_SCH_PROC_IDX1");
            ...
            entity.Property(e => e.JobType)
                ...
                .HasMaxLength(20)
                .IsUnicode(false)
                .HasDefaultValueSql("'''PLSQL_BLOCK'''");
