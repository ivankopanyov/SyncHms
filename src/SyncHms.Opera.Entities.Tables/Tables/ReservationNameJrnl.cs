...
public partial class ReservationNameJrnl
{
    ...
    public decimal? InsertDmlSeqNo { get; set; }
	...
	{
		modelBuilder.Entity<ReservationNameJrnl>(entity =>
        {
            entity.HasKey(e => new { e.ActionInstanceId, e.DmlSeqNo, e.UDFlag, e.Resort, e.ResvNameId })
                .HasName("RESERVATION_NAME_JRNL_PK");

            entity.ToTable("RESERVATION_NAME_JRNL");

            entity.HasIndex(e => e.NameId)
                .HasName("RESERVATION_NAME_JRNL_IND2");

            entity.HasIndex(e => new { e.Resort, e.ResvNameId, e.ActionInstanceId })
                .HasName("RESERVATION_NAME_JRNL_IND1");
            ...
            entity.Property(e => e.InsertDmlSeqNo)
                .HasColumnName("INSERT_DML_SEQ_NO")
                .HasColumnType("NUMBER");
