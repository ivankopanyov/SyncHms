...
public partial class PoliceIfcJrnl
{
	...
	{
		modelBuilder.Entity<PoliceIfcJrnl>(entity =>
        {
            entity.HasKey(e => new { e.JrnlSeqNo, e.ResvNameId, e.Resort, e.PoliceId })
                .HasName("POLICE_IFC_JRNL_PK");

            entity.ToTable("POLICE_IFC_JRNL");

            entity.HasIndex(e => e.ResvNameId)
                .HasName("RESV_NAME_ID_IND");

            entity.HasIndex(e => new { e.Resort, e.Departure })
                .HasName("POLICE_IFC_JRNL_PURGE_IND");

            entity.Property(e => e.JrnlSeqNo)
                .HasColumnName("JRNL_SEQ_NO")
