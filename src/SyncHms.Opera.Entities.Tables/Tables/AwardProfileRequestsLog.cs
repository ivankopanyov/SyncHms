...
public partial class AwardProfileRequestsLog
{
	...
	{
		modelBuilder.Entity<AwardProfileRequestsLog>(entity =>
        {
            entity.HasKey(e => e.LogId)
                .HasName("AW_PR_REQ_LOG_PK");

            entity.ToTable("AWARD_PROFILE_REQUESTS_LOG");

            entity.HasIndex(e => new { e.Resort, e.CertificateNumber })
                .HasName("AW_PR_REQ_LOG_IDX3");

            entity.HasIndex(e => new { e.Resort, e.InsertTs })
                .HasName("AW_PR_REQ_LOG_IDX2");

            entity.HasIndex(e => new { e.Resort, e.ResvNameId })
                .HasName("AW_PR_REQ_LOG_IDX1");
