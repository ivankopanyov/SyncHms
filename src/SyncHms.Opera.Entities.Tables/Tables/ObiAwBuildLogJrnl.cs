...
public partial class ObiAwBuildLogJrnl
{
	...
	{
		modelBuilder.Entity<ObiAwBuildLogJrnl>(entity =>
        {
            entity.HasKey(e => e.ObiAwBuildLogJrnlSeqno)
                .HasName("OBI_AW_BUILD_LOG_JRNL_PK");

            entity.ToTable("OBI_AW_BUILD_LOG_JRNL");

            entity.HasIndex(e => e.BuildLogId)
                .HasName("OBI_AW_BUILD_LOG_JRNL_IND1");

            entity.Property(e => e.ObiAwBuildLogJrnlSeqno)
                .HasColumnName("OBI_AW_BUILD_LOG_JRNL_SEQNO")
            ...
            entity.Property(e => e.DiuFlag)
                .HasColumnName("DIU_FLAG")
                .HasMaxLength(1)
                .IsUnicode(false);
