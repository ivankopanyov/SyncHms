...
public partial class ExpMysExport
{
    ...
    public decimal? RevenueBktAmount1 { get; set; }
    public decimal? RevenueBktAmount2 { get; set; }
    public decimal? RevenueBktAmount3 { get; set; }
    public decimal? RevenueBktAmount4 { get; set; }
    public decimal? RevenueBktAmount5 { get; set; }
    public decimal? RevenueBktAmount6 { get; set; }
    public decimal? RevenueBktAmount7 { get; set; }
    public decimal? RevenueBktAmount8 { get; set; }
    public decimal? RevenueBktAmount9 { get; set; }
    public decimal? RevenueBktAmount10 { get; set; }
    ...
    public string? ReservationInsertUserName { get; set; }
    ...
    public DateTime? ConfirmationLetterPrintDate { get; set; }
    ...
    public string? RateFolioText { get; set; }
    ...
    public decimal? ReservationRoomRevenue { get; set; }
    public decimal? ReservationOtherRevenue { get; set; }
    public decimal? ReservationFbRevenue { get; set; }
    ...
    public decimal? ReservationFolioNumber { get; set; }
    public string? AccompanyingName1 { get; set; }
    public string? AccompanyingName2 { get; set; }
    public string? ClAuthorizedYn { get; set; }
    public decimal? ResvConfLetterId { get; set; }
    public decimal? ReservationInsertUserId { get; set; }
    public string? Packages { get; set; }
    public decimal? ExchangeRate { get; set; }
    public DateTime? ActualCheckOutDate { get; set; }
    public string? CurrencyCode { get; set; }
    public string? RateRoomType { get; set; }
    public string? CreditCardApprovalCode { get; set; }
    public decimal? CreditCardApprovalAmount { get; set; }
    public decimal? DiscountAmount { get; set; }
    public string? GuestFax { get; set; }
    public string? AccompanyingName3 { get; set; }
    public string? CreditCardNameOnCard { get; set; }
    public string? VideoCheckoutYn { get; set; }
    public decimal? HurdleValue { get; set; }
    public string? HurdleOverrideYn { get; set; }
    public DateTime? LoyaltyMemberExpiration { get; set; }
    public DateTime? OriginalDeparture { get; set; }
    public decimal? ReservationUpdateUserId { get; set; }
    public decimal? AverageRoomRate { get; set; }
    public decimal? MembershipAverageRoomRate { get; set; }
    ...
    public string? ReservationPaymentMethod { get; set; }
    public DateTime? PaymentCreditCardExpy { get; set; }
    public string? DefaultMemberCardNo { get; set; }
    public string? DefaultMemberCardLevel { get; set; }
    public DateTime? DefaultMemberCardExpy { get; set; }
    ...
    public string? GuestAddressType { get; set; }
    public string? NameTaxType { get; set; }
    public string? CommissionCode { get; set; }
    public decimal? CommissionPaid { get; set; }
    public decimal? TotalArrivalRecords { get; set; }
    public decimal? TotalDepartureRecords { get; set; }
    public string? CompanyAddressType { get; set; }
    public string? InternalRoomCatNumber { get; set; }
    public decimal? LoyaltyMemberBaseRevenue { get; set; }
    public decimal? LoyaltyMemberBonusRevenue { get; set; }
    public decimal? AirlineMemberBonusRevenue { get; set; }
    public decimal? AirlineMemberBaseRevenue { get; set; }
    public decimal? ContactNameId { get; set; }
    public string? Promotions { get; set; }
    public string? RoomTypeDescription { get; set; }
    public string? VipStatus { get; set; }
    public string? ResvDbAccountNo { get; set; }
    public decimal? ResvContactId { get; set; }
    public string? ProfileSpecials { get; set; }
    public string? PreferredRoomFeatures { get; set; }
    public DateTime? BirthDate { get; set; }
    public string? TaRecordLocator { get; set; }
    public decimal? RevenueBktAmount11 { get; set; }
    public decimal? RevenueBktAmount12 { get; set; }
    public decimal? RevenueBktAmount13 { get; set; }
    public decimal? RevenueBktAmount14 { get; set; }
    public decimal? RevenueBktAmount15 { get; set; }
    public string? MystiqueEmail { get; set; }
	...
	{
		modelBuilder.Entity<ExpMysExport>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("EXP_MYS_EXPORT");

            entity.Property(e => e.AccompanyingName1)
                .HasColumnName("ACCOMPANYING_NAME_1")
                .HasMaxLength(100)
                .IsUnicode(false);

            entity.Property(e => e.AccompanyingName2)
                .HasColumnName("ACCOMPANYING_NAME_2")
                .HasMaxLength(100)
                .IsUnicode(false);

            entity.Property(e => e.AccompanyingName3)
                .HasColumnName("ACCOMPANYING_NAME_3")
                .HasMaxLength(100)
                .IsUnicode(false);
            ...
            entity.Property(e => e.AgentAddress1)
                .HasColumnName("AGENT_ADDRESS_1")
                .HasMaxLength(100)
                .IsUnicode(false);

            entity.Property(e => e.AgentAddress2)
                .HasColumnName("AGENT_ADDRESS_2")
                .HasMaxLength(100)
                .IsUnicode(false);
            ...
            entity.Property(e => e.AgentCountryCode)
                .HasColumnName("AGENT_COUNTRY_CODE")
                .HasMaxLength(100)
                .IsUnicode(false);
            ...
            entity.Property(e => e.AgentPostalCode)
                .HasColumnName("AGENT_POSTAL_CODE")
                .HasMaxLength(100)
                .IsUnicode(false);

            entity.Property(e => e.AgentStateCode)
                .HasColumnName("AGENT_STATE_CODE")
                .HasMaxLength(100)
                .IsUnicode(false);

            entity.Property(e => e.AgentTelephone)
                .HasColumnName("AGENT_TELEPHONE")
                .HasMaxLength(100)
                .IsUnicode(false);
            ...
            entity.Property(e => e.AirlineMemberBaseRevenue)
                .HasColumnName("AIRLINE_MEMBER_BASE_REVENUE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.AirlineMemberBonusRevenue)
                .HasColumnName("AIRLINE_MEMBER_BONUS_REVENUE")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.ClAuthorizedYn)
                .HasColumnName("CL_AUTHORIZED_YN")
                .HasMaxLength(100)
                .IsUnicode(false);
            ...
            entity.Property(e => e.CompanyCountryCode)
                .HasColumnName("COMPANY_COUNTRY_CODE")
                .HasMaxLength(100)
                .IsUnicode(false);
            ...
            entity.Property(e => e.CompanyStateCode)
                .HasColumnName("COMPANY_STATE_CODE")
                .HasMaxLength(100)
                .IsUnicode(false);
            ...
            entity.Property(e => e.ConfirmationLetterPrintDate)
                .HasColumnName("CONFIRMATION_LETTER_PRINT_DATE")
                .HasColumnType("DATE");
            ...
            entity.Property(e => e.CreditCardApprovalAmount)
                .HasColumnName("CREDIT_CARD_APPROVAL_AMOUNT")
                .HasColumnType("NUMBER");

            entity.Property(e => e.CreditCardApprovalCode)
                .HasColumnName("CREDIT_CARD_APPROVAL_CODE")
                .HasMaxLength(100)
                .IsUnicode(false);
            ...
            entity.Property(e => e.CreditCardNameOnCard)
                .HasColumnName("CREDIT_CARD_NAME_ON_CARD")
                .HasMaxLength(100)
                .IsUnicode(false);
            ...
            entity.Property(e => e.DefaultMemberCardExpy)
                .HasColumnName("DEFAULT_MEMBER_CARD_EXPY")
                .HasColumnType("DATE");

            entity.Property(e => e.DefaultMemberCardLevel)
                .HasColumnName("DEFAULT_MEMBER_CARD_LEVEL")
                .HasMaxLength(100)
                .IsUnicode(false);

            entity.Property(e => e.DefaultMemberCardNo)
                .HasColumnName("DEFAULT_MEMBER_CARD_NO")
                .HasMaxLength(100)
                .IsUnicode(false);
            ...
            entity.Property(e => e.DepositPayDate)
                .HasColumnName("DEPOSIT_PAY_DATE")
                .HasColumnType("DATE");
            ...
            entity.Property(e => e.GuestAddressType)
                .HasColumnName("GUEST_ADDRESS_TYPE")
                .HasMaxLength(100)
                .IsUnicode(false);
            ...
            entity.Property(e => e.GuestPassport)
                .HasColumnName("GUEST_PASSPORT")
                .HasMaxLength(100)
                .IsUnicode(false);
            ...
            entity.Property(e => e.HurdleOverrideYn)
                .HasColumnName("HURDLE_OVERRIDE_YN")
                .HasMaxLength(100)
                .IsUnicode(false);

            entity.Property(e => e.HurdleValue)
                .HasColumnName("HURDLE_VALUE")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.InternalRoomCatNumber)
                .HasColumnName("INTERNAL_ROOM_CAT_NUMBER")
                .HasMaxLength(100)
                .IsUnicode(false);
            ...
            entity.Property(e => e.LoyaltyMemberBaseRevenue)
                .HasColumnName("LOYALTY_MEMBER_BASE_REVENUE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.LoyaltyMemberBonusRevenue)
                .HasColumnName("LOYALTY_MEMBER_BONUS_REVENUE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.LoyaltyMemberExpiration)
                .HasColumnName("LOYALTY_MEMBER_EXPIRATION")
                .HasColumnType("DATE");
            ...
            entity.Property(e => e.MembershipAverageRoomRate)
                .HasColumnName("MEMBERSHIP_AVERAGE_ROOM_RATE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.MystiqueEmail)
                .HasColumnName("MYSTIQUE_EMAIL")
                .IsUnicode(false);
            ...
            entity.Property(e => e.OriginalDeparture)
                .HasColumnName("ORIGINAL_DEPARTURE")
                .HasColumnType("DATE");
            ...
            entity.Property(e => e.PaymentCreditCardExpy)
                .HasColumnName("PAYMENT_CREDIT_CARD_EXPY")
                .HasColumnType("DATE");

            entity.Property(e => e.PaymentCreditCardNumber)
                .HasColumnName("PAYMENT_CREDIT_CARD_NUMBER")
                .IsUnicode(false);
            ...
            entity.Property(e => e.PreferredRoomFeatures)
                .HasColumnName("PREFERRED_ROOM_FEATURES")
                .HasMaxLength(100)
                .IsUnicode(false);
            ...
            entity.Property(e => e.ProfileSpecials)
                .HasColumnName("PROFILE_SPECIALS")
                .HasMaxLength(100)
                .IsUnicode(false);
            ...
            entity.Property(e => e.RateFolioText)
                .HasColumnName("RATE_FOLIO_TEXT")
                .HasMaxLength(2000)
                .IsUnicode(false);

            entity.Property(e => e.RateRoomType)
                .HasColumnName("RATE_ROOM_TYPE")
                .HasMaxLength(100)
                .IsUnicode(false);
            ...
            entity.Property(e => e.ReservationCredit)
                .HasColumnName("RESERVATION_CREDIT")
                .HasColumnType("NUMBER");

            entity.Property(e => e.ReservationFbRevenue)
                .HasColumnName("RESERVATION_FB_REVENUE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.ReservationFolioNumber)
                .HasColumnName("RESERVATION_FOLIO_NUMBER")
                .HasColumnType("NUMBER");

            entity.Property(e => e.ReservationInsertUserId)
                .HasColumnName("RESERVATION_INSERT_USER_ID")
                .HasColumnType("NUMBER");

            entity.Property(e => e.ReservationInsertUserName)
                .HasColumnName("RESERVATION_INSERT_USER_NAME")
                .HasMaxLength(100)
                .IsUnicode(false);

            entity.Property(e => e.ReservationOtherRevenue)
                .HasColumnName("RESERVATION_OTHER_REVENUE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.ReservationPaymentMethod)
                .HasColumnName("RESERVATION_PAYMENT_METHOD")
                .HasMaxLength(100)
                .IsUnicode(false);

            entity.Property(e => e.ReservationRoomRevenue)
                .HasColumnName("RESERVATION_ROOM_REVENUE")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.ReservationUpdateUserId)
                .HasColumnName("RESERVATION_UPDATE_USER_ID")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.ResvDbAccountNo)
                .HasColumnName("RESV_DB_ACCOUNT_NO")
                .HasMaxLength(100)
                .IsUnicode(false);
            ...
            entity.Property(e => e.RevenueBktAmount1)
                .HasColumnName("REVENUE_BKT_AMOUNT_1")
                .HasColumnType("NUMBER");

            entity.Property(e => e.RevenueBktAmount10)
                .HasColumnName("REVENUE_BKT_AMOUNT_10")
                .HasColumnType("NUMBER");

            entity.Property(e => e.RevenueBktAmount11)
                .HasColumnName("REVENUE_BKT_AMOUNT_11")
                .HasColumnType("NUMBER");

            entity.Property(e => e.RevenueBktAmount12)
                .HasColumnName("REVENUE_BKT_AMOUNT_12")
                .HasColumnType("NUMBER");

            entity.Property(e => e.RevenueBktAmount13)
                .HasColumnName("REVENUE_BKT_AMOUNT_13")
                .HasColumnType("NUMBER");

            entity.Property(e => e.RevenueBktAmount14)
                .HasColumnName("REVENUE_BKT_AMOUNT_14")
                .HasColumnType("NUMBER");

            entity.Property(e => e.RevenueBktAmount15)
                .HasColumnName("REVENUE_BKT_AMOUNT_15")
                .HasColumnType("NUMBER");

            entity.Property(e => e.RevenueBktAmount2)
                .HasColumnName("REVENUE_BKT_AMOUNT_2")
                .HasColumnType("NUMBER");

            entity.Property(e => e.RevenueBktAmount3)
                .HasColumnName("REVENUE_BKT_AMOUNT_3")
                .HasColumnType("NUMBER");

            entity.Property(e => e.RevenueBktAmount4)
                .HasColumnName("REVENUE_BKT_AMOUNT_4")
                .HasColumnType("NUMBER");

            entity.Property(e => e.RevenueBktAmount5)
                .HasColumnName("REVENUE_BKT_AMOUNT_5")
                .HasColumnType("NUMBER");

            entity.Property(e => e.RevenueBktAmount6)
                .HasColumnName("REVENUE_BKT_AMOUNT_6")
                .HasColumnType("NUMBER");

            entity.Property(e => e.RevenueBktAmount7)
                .HasColumnName("REVENUE_BKT_AMOUNT_7")
                .HasColumnType("NUMBER");

            entity.Property(e => e.RevenueBktAmount8)
                .HasColumnName("REVENUE_BKT_AMOUNT_8")
                .HasColumnType("NUMBER");

            entity.Property(e => e.RevenueBktAmount9)
                .HasColumnName("REVENUE_BKT_AMOUNT_9")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.TotalArrivalRecords)
                .HasColumnName("TOTAL_ARRIVAL_RECORDS")
                .HasColumnType("NUMBER");

            entity.Property(e => e.TotalDepartureRecords)
                .HasColumnName("TOTAL_DEPARTURE_RECORDS")
                .HasColumnType("NUMBER");
