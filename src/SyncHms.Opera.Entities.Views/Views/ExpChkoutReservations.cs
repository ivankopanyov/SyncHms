...
public partial class ExpChkoutReservations
{
    ...
    public string? GuestCountryDescription { get; set; }
    ...
    public string? ReserverContactName { get; set; }
    public string? ReserverAddress1 { get; set; }
    public string? ReserverAddress2 { get; set; }
    public string? ReserverAddress3 { get; set; }
    public string? ReserverCity { get; set; }
    public string? ReserverState { get; set; }
    public string? ReserverPostalCode { get; set; }
    public string? ReserverCountry { get; set; }
    public string? ReserverTelephone { get; set; }
    public string? ReserverFax { get; set; }
    ...
    public string? ReserverIdTag { get; set; }
    public string? CompanyIdTag { get; set; }
    public string? InputSource { get; set; }
    public string? GnrNumber { get; set; }
    public string? PostingPlanIndicator { get; set; }
    ...
    public decimal? TrxNumber { get; set; }
    public string? ChequeNo { get; set; }
    public string? SccMembershipNo { get; set; }
    public string? SccMembershipLevel { get; set; }
    public string? MailListYn { get; set; }
    public string? MktResearchYn { get; set; }
    ...
    public decimal? RoomsSingleOcc { get; set; }
    public decimal? RoomsMultiOcc { get; set; }
    public decimal? RoomsAvail { get; set; }
    ...
    public decimal? LoyaltyBaseRevenue { get; set; }
    public decimal? LoyaltyBonusRevenue { get; set; }
    ...
    public decimal? AirlineBaseRevenue { get; set; }
    public decimal? AirlineBonusRevenue { get; set; }
    public decimal? RevenueBkt1Amount1 { get; set; }
    public decimal? RevenueBkt1Amount2 { get; set; }
    public decimal? RevenueBkt1Amount3 { get; set; }
    public decimal? RevenueBkt1Amount4 { get; set; }
    public decimal? RevenueBkt1Amount5 { get; set; }
    public decimal? RevenueBkt1Amount6 { get; set; }
    public decimal? RevenueBkt1Amount7 { get; set; }
    public decimal? RevenueBkt1Amount8 { get; set; }
    public decimal? RevenueBkt1Amount9 { get; set; }
    public decimal? RevenueBkt1Amount10 { get; set; }
    public decimal? PseudoTotalPoints { get; set; }
    public string? PseudoMemType { get; set; }
    public string? DayType { get; set; }
    public string? TrxPrintedYn { get; set; }
    ...
    public string? XpostalCode { get; set; }
	...
	{
		modelBuilder.Entity<ExpChkoutReservations>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("EXP_CHKOUT_RESERVATIONS");
            ...
            entity.Property(e => e.AirlineBaseRevenue)
                .HasColumnName("AIRLINE_BASE_REVENUE")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.AirlineBonusRevenue)
                .HasColumnName("AIRLINE_BONUS_REVENUE")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.CompanyIdTag)
                .HasColumnName("COMPANY_ID_TAG")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.GnrNumber)
                .HasColumnName("GNR_NUMBER")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.GuestCountryDescription)
                .HasColumnName("GUEST_COUNTRY_DESCRIPTION")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.LoyaltyBaseRevenue)
                .HasColumnName("LOYALTY_BASE_REVENUE")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.LoyaltyBonusRevenue)
                .HasColumnName("LOYALTY_BONUS_REVENUE")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.MktResearchYn)
                .HasColumnName("MKT_RESEARCH_YN")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.PaymentCreditCardNo)
                .HasColumnName("PAYMENT_CREDIT_CARD_NO")
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.PostingPlanIndicator)
                .HasColumnName("POSTING_PLAN_INDICATOR")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.PseudoTotalPoints)
                .HasColumnName("PSEUDO_TOTAL_POINTS")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.ReserverAddress1)
                .HasColumnName("RESERVER_ADDRESS1")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.ReserverAddress2)
                .HasColumnName("RESERVER_ADDRESS2")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.ReserverAddress3)
                .HasColumnName("RESERVER_ADDRESS3")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.ReserverCity)
                .HasColumnName("RESERVER_CITY")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.ReserverContactName)
                .HasColumnName("RESERVER_CONTACT_NAME")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.ReserverCountry)
                .HasColumnName("RESERVER_COUNTRY")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.ReserverFax)
                .HasColumnName("RESERVER_FAX")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.ReserverIdTag)
                .HasColumnName("RESERVER_ID_TAG")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.ReserverPostalCode)
                .HasColumnName("RESERVER_POSTAL_CODE")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.ReserverState)
                .HasColumnName("RESERVER_STATE")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.ReserverTelephone)
                .HasColumnName("RESERVER_TELEPHONE")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.RevenueBkt1Amount1)
                .HasColumnName("REVENUE_BKT1_AMOUNT_1")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.RevenueBkt1Amount10)
                .HasColumnName("REVENUE_BKT1_AMOUNT_10")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.RevenueBkt1Amount2)
                .HasColumnName("REVENUE_BKT1_AMOUNT_2")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.RevenueBkt1Amount3)
                .HasColumnName("REVENUE_BKT1_AMOUNT_3")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.RevenueBkt1Amount4)
                .HasColumnName("REVENUE_BKT1_AMOUNT_4")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.RevenueBkt1Amount5)
                .HasColumnName("REVENUE_BKT1_AMOUNT_5")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.RevenueBkt1Amount6)
                .HasColumnName("REVENUE_BKT1_AMOUNT_6")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.RevenueBkt1Amount7)
                .HasColumnName("REVENUE_BKT1_AMOUNT_7")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.RevenueBkt1Amount8)
                .HasColumnName("REVENUE_BKT1_AMOUNT_8")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.RevenueBkt1Amount9)
                .HasColumnName("REVENUE_BKT1_AMOUNT_9")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.RoomsAvail)
                .HasColumnName("ROOMS_AVAIL")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.RoomsMultiOcc)
                .HasColumnName("ROOMS_MULTI_OCC")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.RoomsSingleOcc)
                .HasColumnName("ROOMS_SINGLE_OCC")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.SccMembershipLevel)
                .HasColumnName("SCC_MEMBERSHIP_LEVEL")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.SccMembershipNo)
                .HasColumnName("SCC_MEMBERSHIP_NO")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.TrxPrintedYn)
                .HasColumnName("TRX_PRINTED_YN")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.Xaddress1)
                .HasColumnName("XADDRESS_1")
                .HasMaxLength(200)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.Xaddress2)
                .HasColumnName("XADDRESS_2")
                .HasMaxLength(200)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.Xaddress3)
                .HasColumnName("XADDRESS_3")
                .HasMaxLength(200)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.XpostalCode)
                .HasColumnName("XPOSTAL_CODE")
                .HasMaxLength(200)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.XstateCode)
                .HasColumnName("XSTATE_CODE")
                .HasMaxLength(200)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
