...
public partial class MarketStatDaily
{
	...
	{
		modelBuilder.Entity<MarketStatDaily>(entity =>
        {
            entity.HasKey(e => new { e.Resort, e.BusinessDate, e.MarketCode, e.RoomType, e.MarketMainGroup })
                .HasName("MARKET_STAT_DAILY_PK");

            entity.ToTable("MARKET_STAT_DAILY");

            entity.HasIndex(e => new { e.Resort, e.MarketCode, e.RoomType, e.BusinessDate })
                .HasName("MARKET_STAT_DAILY_IND1");

            entity.HasIndex(e => new { e.Resort, e.MarketMainGroup, e.RoomType, e.BusinessDate })
                .HasName("MARKET_STAT_DAILY_IND2");
