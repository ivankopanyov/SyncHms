...
public partial class IntProcesses
{
	...
	{
		modelBuilder.Entity<IntProcesses>(entity =>
        {
            entity.HasNoKey();

            entity.ToTable("INT_PROCESSES");

            entity.HasIndex(e => new { e.Resort, e.ProcessType, e.InterfaceId })
                .HasName("INT_IP_UK")
                .IsUnique();
