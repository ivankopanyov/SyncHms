...
public partial class RwServerJobQueue
{
    ...
    public decimal? RunElapse { get; set; }
	...
	{
		modelBuilder.Entity<RwServerJobQueue>(entity =>
        {
            entity.HasNoKey();

            entity.ToTable("RW_SERVER_JOB_QUEUE");

            entity.HasIndex(e => e.JobId)
                .HasName("RW_SERVER_JOB_ID");

            entity.HasIndex(e => e.JobQueue)
                .HasName("RW_SERVER_JOB_QUEUE");

            entity.HasIndex(e => new { e.Frmsid, e.JobId })
                .HasName("RW_SERVER_FRMSID_JOB_ID");
            ...
            entity.Property(e => e.JobQueue)
                .HasColumnName("JOB_QUEUE")
                .HasMaxLength(30)
                .IsUnicode(false);
            ...
            entity.Property(e => e.RunElapse)
                .HasColumnName("RUN_ELAPSE")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.TotalElapse)
                .HasColumnName("TOTAL_ELAPSE")
                .HasColumnType("NUMBER");
        });
	}
}
