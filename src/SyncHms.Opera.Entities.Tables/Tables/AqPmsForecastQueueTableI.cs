...
public partial class AqPmsForecastQueueTableI
{
	...
	{
		modelBuilder.Entity<AqPmsForecastQueueTableI>(entity =>
        {
            entity.HasKey(e => new { e.Subscriber, e.Name, e.Queue, e.MsgPriority, e.MsgEnqTime, e.MsgStepNo, e.MsgChainNo, e.MsgLocalOrderNo, e.Msgid })
                .HasName("SYS_IOT_TOP_142022");

            entity.ToTable("AQ$_PMS_FORECAST_QUEUE_TABLE_I");
