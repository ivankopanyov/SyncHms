...
public partial class RateHeaderView
{
    ...
    public string? TrxCodes { get; set; }
    ...
    public string? AsbRateYn { get; set; }
    ...
    public decimal? PmsOrderby { get; set; }
    public decimal? OrsOrderby { get; set; }
	...
	{
		modelBuilder.Entity<RateHeaderView>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("RATE_HEADER_VIEW");
            ...
            entity.Property(e => e.AsbRateYn)
                .HasColumnName("ASB_RATE_YN")
                .IsUnicode(false);
            ...
            entity.Property(e => e.OrsOrderby)
                .HasColumnName("ORS_ORDERBY")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.PmsOrderby)
                .HasColumnName("PMS_ORDERBY")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.TrxCodes)
                .HasColumnName("TRX_CODES")
                .IsUnicode(false);
