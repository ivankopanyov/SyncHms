...
public partial class ReservationPaymentMethods
{
	...
	{
		modelBuilder.Entity<ReservationPaymentMethods>(entity =>
        {
            entity.HasKey(e => new { e.Resort, e.ResvNameId, e.FolioView })
                .HasName("RPM_PK");

            entity.ToTable("RESERVATION$_PAYMENT_METHODS");

            entity.HasIndex(e => e.CreditCardId)
                .HasName("RPM_CCID_IDX");
