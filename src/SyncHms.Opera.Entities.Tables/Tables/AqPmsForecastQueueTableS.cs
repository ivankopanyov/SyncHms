...
public partial class AqPmsForecastQueueTableS
{
	...
	{
		modelBuilder.Entity<AqPmsForecastQueueTableS>(entity =>
        {
            entity.HasKey(e => e.SubscriberId)
                .HasName("SYS_C0037398");

            entity.ToTable("AQ$_PMS_FORECAST_QUEUE_TABLE_S");
