...
public partial class ReservationSummaryLog
{
	...
	{
		modelBuilder.Entity<ReservationSummaryLog>(entity =>
        {
            entity.HasNoKey();

            entity.ToTable("RESERVATION_SUMMARY_LOG");

            entity.HasIndex(e => e.AgentId)
                .HasName("RESV_SUMMARY_LOG_IND5");

            entity.HasIndex(e => e.ParentCompanyId)
                .HasName("RESV_SUMMARY_LOG_IND4");

            entity.HasIndex(e => new { e.Resort, e.UpdateDate })
                .HasName("RESV_SUMMARY_LOG_IND2");

            entity.HasIndex(e => new { e.UpdateBusinessDate, e.Resort })
                .HasName("RESV_SUMMARY_LOG_IND3");

            entity.HasIndex(e => new { e.Id, e.Resort, e.ChangeDate })
                .HasName("RESV_SUMMARY_LOG_PK");

            entity.HasIndex(e => new { e.ConsideredDate, e.ChangeDate, e.EndChangeDate, e.Resort })
                .HasName("RESV_SUMMARY_LOG_IND1");

            entity.HasIndex(e => new { e.EventId, e.EventType, e.Resort, e.ConsideredDate, e.RoomCategory, e.ChangeDate })
                .HasName("RESV_SUMMARY_LOG_UK");
            ...
            entity.Property(e => e.PrevUpdateDate)
                .HasColumnName("PREV_UPDATE_DATE")
                .HasColumnType("DATE");
