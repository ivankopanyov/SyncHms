...
public partial class AqCachedMemcalQTabH
{
	...
	{
		modelBuilder.Entity<AqCachedMemcalQTabH>(entity =>
        {
            entity.HasKey(e => new { e.Msgid, e.Subscriber, e.Name, e.Address })
                .HasName("SYS_IOT_TOP_142097");

            entity.ToTable("AQ$_CACHED$_MEMCAL_Q_TAB_H");
