...
public partial class ExpOcrmReservation
{
    ...
    public decimal? RgvPhoneId { get; set; }
    public decimal? RgvAddressId { get; set; }
	...
	{
		modelBuilder.Entity<ExpOcrmReservation>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("EXP_OCRM_RESERVATION");
            ...
            entity.Property(e => e.RgvAddressId)
                .HasColumnName("RGV_ADDRESS_ID")
                .HasColumnType("NUMBER");

            entity.Property(e => e.RgvPhoneId)
                .HasColumnName("RGV_PHONE_ID")
                .HasColumnType("NUMBER");
