...
public partial class CashierCityledger
{
    ...
    public DateTime? ResortBusinessDate { get; set; }

	public static void OnModelCreating(ModelBuilder modelBuilder, ISet<Type> types)
	{
		modelBuilder.Entity<CashierCityledger>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("CASHIER_CITYLEDGER");
            ...
            entity.Property(e => e.ResortBusinessDate)
                .HasColumnName("RESORT_BUSINESS_DATE")
                .HasColumnType("DATE");
