...
public partial class ObiexpGuestDimBase
{
    ...
    public decimal? IdAttach { get; set; }
    ...
    public string? IncognitoDisplayname { get; set; }
    public string? IncognitoYn { get; set; }
    ...
    public string? LoyaltySegmentCodes { get; set; }
	...
	{
		modelBuilder.Entity<ObiexpGuestDimBase>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("OBIEXP_GUEST_DIM_BASE");
            ...
            entity.Property(e => e.DepartmentNote)
                .HasColumnName("DEPARTMENT_NOTE")
                .IsUnicode(false);
            ...
            entity.Property(e => e.IncognitoDisplayname)
                .HasColumnName("INCOGNITO_DISPLAYNAME")
                .IsUnicode(false);
            ...
            entity.Property(e => e.IncognitoYn)
                .HasColumnName("INCOGNITO_YN")
                .HasMaxLength(1)
                .IsUnicode(false);
            ...
            entity.Property(e => e.LoyaltySegmentCodes)
                .HasColumnName("LOYALTY_SEGMENT_CODES")
                .IsUnicode(false);
            ...
            entity.Property(e => e.RestrictReasonCode)
                .HasColumnName("RESTRICT_REASON_CODE")
                .IsUnicode(false);
