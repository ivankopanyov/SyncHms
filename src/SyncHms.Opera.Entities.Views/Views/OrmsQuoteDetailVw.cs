...
public partial class OrmsQuoteDetailVw
{
	...
	{
		modelBuilder.Entity<OrmsQuoteDetailVw>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("ORMS_QUOTE_DETAIL_VW");

            entity.Property(e => e.AllotmentDate)
                .HasColumnName("ALLOTMENT_DATE")
                .HasColumnType("DATE");

            entity.Property(e => e.AllotmentDateDisplay)
                .HasColumnName("ALLOTMENT_DATE_DISPLAY")
                .IsUnicode(false);
