...
public partial class ReservationSummary
{
	...
	public static void OnModelCreating(ModelBuilder modelBuilder, ISet<Type> types)
	{
		modelBuilder.Entity<ReservationSummary>(entity =>
        {
            ...
            entity.ToTable("RESERVATION_SUMMARY");

            entity.HasIndex(e => e.MarketCode)
                .HasName("RESV_SUMMARY_MARKET_CODE_IDX");

            entity.HasIndex(e => new { e.UpdateBusinessDate, e.Resort })
                .HasName("RESV_SUMMARY_UPDBUSDATE_IDX");

            entity.HasIndex(e => new { e.Resort, e.ConsideredDate, e.MarketCode })
                .HasName("RESERVATION_SUMMARY_MKT");

            entity.HasIndex(e => new { e.Resort, e.ConsideredDate, e.RoomClass })
                .HasName("RESERVATION_SUMMARY_IND2");

            entity.HasIndex(e => new { e.ConsideredDate, e.EventType, e.Resort, e.RoomClass })
                .HasName("RESERVATION_SUMMARY_IND3");

            entity.HasIndex(e => new { e.EventType, e.ConsideredDate, e.Resort, e.ResvInvType })
                .HasName("RESERVATION_SUMMARY_IND10");

            entity.HasIndex(e => new { e.EventType, e.EventId, e.RoomCategory, e.ConsideredDate })
                .HasName("RESERVATION_SUMMARY_IND6");

            entity.HasIndex(e => new { e.EventType, e.Resort, e.AllotmentHeaderId, e.ConsideredDate })
                .HasName("RESERVATION_SUMMARY_IND7");

            entity.HasIndex(e => new { e.EventType, e.Resort, e.EventId, e.ConsideredDate })
                .HasName("RESERVATION_SUMMARY_IND1");

            entity.HasIndex(e => new { e.Resort, e.ConsideredDate, e.EventType, e.ResvInvType })
                .HasName("RESERVATION_SUMMARY_IND8");

            entity.HasIndex(e => new { e.Resort, e.EventType, e.ConsideredDate, e.ResvInvType })
                .HasName("RESERVATION_SUMMARY_IND9");

            entity.HasIndex(e => new { e.ConsideredDate, e.EventType, e.ResvStatus, e.RoomClass, e.Resort })
                .HasName("RESERVATION_SUMMARY_IND4");

            entity.HasIndex(e => new { e.EventId, e.EventType, e.Resort, e.ConsideredDate, e.RoomCategory })
                .HasName("RESERVATION_SUMMARY_EVENT_UK")
                .IsUnique();
