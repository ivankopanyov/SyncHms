...
public partial class BofCityledTrxcodeDetails
{
    public string? Resort { get; set; }
    public decimal? BillNo { get; set; }
    public string? BillType { get; set; }
    public decimal? ArDebit { get; set; }
    public decimal? ArTotalAppliedAmount { get; set; }
    public DateTime? TrxDate { get; set; }
    public string? TrxCode { get; set; }
    public DateTime? PostingTrxDate { get; set; }
    ...
    public decimal? FolioTotalGrossAmount { get; set; }
    public decimal? CalcGrossAmount { get; set; }
    public decimal? CalcAppliedAmount { get; set; }
	...
	{
		modelBuilder.Entity<BofCityledTrxcodeDetails>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("BOF_CITYLED_TRXCODE_DETAILS");
            ...
            entity.Property(e => e.ArTotalAppliedAmount)
                .HasColumnName("AR_TOTAL_APPLIED_AMOUNT")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.CalcAppliedAmount)
                .HasColumnName("CALC_APPLIED_AMOUNT")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.FolioTotalGrossAmount)
                .HasColumnName("FOLIO_TOTAL_GROSS_AMOUNT")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.PostingTrxDate)
                .HasColumnName("POSTING_TRX_DATE")
                .HasColumnType("DATE");
