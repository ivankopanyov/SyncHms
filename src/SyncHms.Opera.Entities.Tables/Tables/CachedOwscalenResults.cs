...
public partial class CachedOwscalenResults
{
	...
	{
		modelBuilder.Entity<CachedOwscalenResults>(entity =>
        {
            entity.HasNoKey();

            entity.ToTable("CACHED$_OWSCALEN_RESULTS");

            entity.HasIndex(e => new { e.ChannelCode, e.Resort, e.StayDate, e.Adults, e.Children, e.Children1, e.Children2, e.Children3, e.RateCodes, e.RoomTypes, e.NoRooms, e.CompanyId })
                .HasName("CACHED$_OWSCALEN_RESULTS_IDX");
