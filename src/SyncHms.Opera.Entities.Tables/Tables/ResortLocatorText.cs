...
public partial class ResortLocatorText
{
	...
	{
		modelBuilder.Entity<ResortLocatorText>(entity =>
        {
            entity.HasKey(e => new { e.LocatorCode, e.Resort })
                .HasName("LOCATOR_TEXT_PK");

            entity.ToTable("RESORT_LOCATOR_TEXT");
