...
public partial class RoomingListImport
{
	...
	{
		modelBuilder.Entity<RoomingListImport>(entity =>
        {
            entity.HasKey(e => e.RoomingListId)
                .HasName("ROOMING_LIST_IMP_PK");

            entity.ToTable("ROOMING_LIST_IMPORT");

            entity.HasIndex(e => new { e.Resort, e.BlockCode, e.RecordNumber })
                .HasName("ROOMING_LIST_IMP_UK")
                .IsUnique();

            entity.Property(e => e.RoomingListId)
                .HasColumnName("ROOMING_LIST_ID")
            ...
            entity.Property(e => e.GuestFirstAlternateName)
                .HasColumnName("GUEST_FIRST_ALTERNATE_NAME")
                .HasMaxLength(40)
                .IsUnicode(false);
            ...
            entity.Property(e => e.GuestLastAlternateName)
                .HasColumnName("GUEST_LAST_ALTERNATE_NAME")
                .HasMaxLength(40)
                .IsUnicode(false);
            ...
            entity.Property(e => e.NumberAdults)
                .HasColumnName("NUMBER_ADULTS")
                .HasColumnType("NUMBER")
                .HasDefaultValueSql("1 ");

            entity.Property(e => e.NumberChildren)
            ...
            entity.Property(e => e.ShareRecordNumber)
                .HasColumnName("SHARE_RECORD_NUMBER")
                .HasMaxLength(20)
                .IsUnicode(false);
