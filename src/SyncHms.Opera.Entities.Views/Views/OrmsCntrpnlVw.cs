...
public partial class OrmsCntrpnlVw
{
    ...
    public decimal? OtbTrnAdr { get; set; }
    public decimal? OtbTrnRev { get; set; }
    public decimal? OtbRev { get; set; }
    public decimal? OtbAdrComp { get; set; }
    public decimal? OtbRevpar { get; set; }
    public decimal? OtbTrnRevpar { get; set; }
	...
	{
		modelBuilder.Entity<OrmsCntrpnlVw>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("ORMS_CNTRPNL_VW");
            ...
            entity.Property(e => e.ForRev)
                .HasColumnName("FOR_REV")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.ForTrnRevpar)
                .HasColumnName("FOR_TRN_REVPAR")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.OtbRev)
                .HasColumnName("OTB_REV")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.OtbTrnAdr)
                .HasColumnName("OTB_TRN_ADR")
                .HasColumnType("NUMBER");

            entity.Property(e => e.OtbTrnRev)
                .HasColumnName("OTB_TRN_REV")
                .HasColumnType("NUMBER");

            entity.Property(e => e.OtbTrnRevpar)
                .HasColumnName("OTB_TRN_REVPAR")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.TrnAdrFore)
                .HasColumnName("TRN_ADR_FORE")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.TrnRevFore)
                .HasColumnName("TRN_REV_FORE")
                .HasColumnType("NUMBER");
