...
public partial class DmRoomsSnapshotVw
{
    ...
    public DateTime? RoomStatusChangeDate { get; set; }
	...
	{
		modelBuilder.Entity<DmRoomsSnapshotVw>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("DM_ROOMS_SNAPSHOT_VW");
            ...
            entity.Property(e => e.BlockRoomStatus)
                .HasColumnName("BLOCK_ROOM_STATUS")
                .HasMaxLength(20)
                .IsUnicode(false);
            ...
            entity.Property(e => e.RoomStatusChangeDate)
                .HasColumnName("ROOM_STATUS_CHANGE_DATE")
                .HasColumnType("DATE");
        });
	}
}
