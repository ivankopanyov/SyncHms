...
public partial class RepReservationFin
{
	...
	{
		modelBuilder.Entity<RepReservationFin>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("REP_RESERVATION_FIN");
            ...
            entity.Property(e => e.OverLimit)
                .HasColumnName("OVER_LIMIT")
                .HasColumnType("NUMBER");
