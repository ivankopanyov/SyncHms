...
public partial class ObiTimeDim
{
    ...
    public string? PAllDesc { get; set; }
	...
	{
		modelBuilder.Entity<ObiTimeDim>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("OBI_TIME_DIM");
            ...
            entity.Property(e => e.PAllDesc)
                .HasColumnName("P_ALL_DESC")
                .IsUnicode(false);

            entity.Property(e => e.PAllId)
                .HasColumnName("P_ALL_ID")
                .IsUnicode(false);

            entity.Property(e => e.PCy)
                .HasColumnName("P_CY")
                .IsUnicode(false);

            entity.Property(e => e.PFy)
                .HasColumnName("P_FY")
                .IsUnicode(false);
