...
public partial class ArFolioFooter
{
	...
	{
		modelBuilder.Entity<ArFolioFooter>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("AR_FOLIO_FOOTER");
            ...
            entity.Property(e => e.InvoiceNumberFooter)
                .HasColumnName("INVOICE_NUMBER_FOOTER")
                .HasColumnType("NUMBER");
