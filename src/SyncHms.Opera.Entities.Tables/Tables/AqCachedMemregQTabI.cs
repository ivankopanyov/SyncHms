...
public partial class AqCachedMemregQTabI
{
	...
	{
		modelBuilder.Entity<AqCachedMemregQTabI>(entity =>
        {
            entity.HasKey(e => new { e.Subscriber, e.Name, e.Queue, e.MsgEnqTime, e.MsgStepNo, e.MsgChainNo, e.MsgLocalOrderNo, e.Msgid })
                .HasName("SYS_IOT_TOP_165794");

            entity.ToTable("AQ$_CACHED$_MEMREG_Q_TAB_I");
