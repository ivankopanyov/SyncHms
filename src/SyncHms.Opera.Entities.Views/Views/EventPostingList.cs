...
public partial class EventPostingList
{
	...
	{
		modelBuilder.Entity<EventPostingList>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("EVENT_POSTING_LIST");
            ...
            entity.Property(e => e.PostedRevenue)
                .HasColumnName("POSTED_REVENUE")
                .HasColumnType("NUMBER");
