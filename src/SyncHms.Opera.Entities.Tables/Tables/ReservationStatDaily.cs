...
public partial class ReservationStatDaily
{
    ...
    public decimal? PrAdvFoodRevenue { get; set; }
    public decimal? PrAdvNonRevenue { get; set; }
    public decimal? PrAdvOtherRevenue { get; set; }
    public decimal? PrAdvRoomRevenue { get; set; }
    public decimal? PrAdvTotalFoodTax { get; set; }
    public decimal? PrAdvTotalNonRevenueTax { get; set; }
    public decimal? PrAdvTotalOtherTax { get; set; }
    public decimal? PrAdvTotalRevenue { get; set; }
    public decimal? PrAdvTotalRoomTax { get; set; }
    public decimal? PrAdvTotalTax { get; set; }
    public decimal? UpsoldRevenue { get; set; }
	...
	{
		modelBuilder.Entity<ReservationStatDaily>(entity =>
        {
            entity.HasNoKey();

            entity.ToTable("RESERVATION_STAT_DAILY");

            entity.HasIndex(e => new { e.AllotmentHeaderId, e.Resort, e.BusinessDate })
                .HasName("RESERVATION_STAT_DAILY_IND8");

            entity.HasIndex(e => new { e.BiResvNameId, e.BusinessDate, e.Resort })
                .HasName("RESERVATION_STAT_DAILY_BI");

            entity.HasIndex(e => new { e.ContactId, e.Resort, e.BusinessDate })
                .HasName("RESERVATION_STAT_DAILY_IND9");

            entity.HasIndex(e => new { e.GroupId, e.Resort, e.BusinessDate })
                .HasName("RESERVATION_STAT_DAILY_IND6");

            entity.HasIndex(e => new { e.NameId, e.Resort, e.BusinessDate })
                .HasName("RESERVATION_STAT_DAILY_IND3");

            entity.HasIndex(e => new { e.Resort, e.BusinessDate, e.ContactYn })
                .HasName("RESERVATION_STAT_DAILY_IND2");

            entity.HasIndex(e => new { e.Resort, e.ResvNameId, e.BusinessDate })
                .HasName("RESERVATION_STAT_DAILY_IND1");

            entity.HasIndex(e => new { e.Resort, e.Room, e.BusinessDate })
                .HasName("RESERVATION_STAT_DAILY_IND10");

            entity.HasIndex(e => new { e.AgentId, e.Resort, e.BusinessDate, e.RateCode })
                .HasName("RESERVATION_STAT_DAILY_IND5");

            entity.HasIndex(e => new { e.CompanyId, e.Resort, e.BusinessDate, e.RateCode })
                .HasName("RESERVATION_STAT_DAILY_IND4");

            entity.HasIndex(e => new { e.ParentCompanyId, e.Resort, e.BusinessDate, e.RateCode })
                .HasName("RESERVATION_STAT_DAILY_IND11");

            entity.HasIndex(e => new { e.SourceProfId, e.Resort, e.BusinessDate, e.RateCode })
                .HasName("RESERVATION_STAT_DAILY_IND7");
            ...
            entity.Property(e => e.PrAdvFoodRevenue)
                .HasColumnName("PR_ADV_FOOD_REVENUE")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.PrAdvNonRevenue)
                .HasColumnName("PR_ADV_NON_REVENUE")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.PrAdvOtherRevenue)
                .HasColumnName("PR_ADV_OTHER_REVENUE")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.PrAdvRoomRevenue)
                .HasColumnName("PR_ADV_ROOM_REVENUE")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.PrAdvTotalFoodTax)
                .HasColumnName("PR_ADV_TOTAL_FOOD_TAX")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.PrAdvTotalNonRevenueTax)
                .HasColumnName("PR_ADV_TOTAL_NON_REVENUE_TAX")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.PrAdvTotalOtherTax)
                .HasColumnName("PR_ADV_TOTAL_OTHER_TAX")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.PrAdvTotalRevenue)
                .HasColumnName("PR_ADV_TOTAL_REVENUE")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.PrAdvTotalRoomTax)
                .HasColumnName("PR_ADV_TOTAL_ROOM_TAX")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.PrAdvTotalTax)
                .HasColumnName("PR_ADV_TOTAL_TAX")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.UpsoldRevenue)
                .HasColumnName("UPSOLD_REVENUE")
                .HasColumnType("NUMBER");
