...
public partial class RateCodeStatDaily
{
	...
	{
		modelBuilder.Entity<RateCodeStatDaily>(entity =>
        {
            entity.HasKey(e => new { e.Resort, e.BusinessDate, e.RateCode, e.RoomType, e.RateCategory })
                .HasName("RATE_CODE_STAT_DAILY_PK");

            entity.ToTable("RATE_CODE_STAT_DAILY");

            entity.HasIndex(e => new { e.Resort, e.RateCategory, e.RoomType, e.BusinessDate })
                .HasName("RATE_CODE_STAT_DAILY_IND2");

            entity.HasIndex(e => new { e.Resort, e.RateCode, e.RoomType, e.BusinessDate })
                .HasName("RATE_CODE_STAT_DAILY_IND1");
