...
public partial class PmsForecastQueueTable
{
	...
	{
		modelBuilder.Entity<PmsForecastQueueTable>(entity =>
        {
            entity.HasKey(e => e.Msgid)
                .HasName("SYS_C0037395");

            entity.ToTable("PMS_FORECAST_QUEUE_TABLE");

            entity.HasIndex(e => e.Corrid)
                .HasName("CORRID_IDX");
