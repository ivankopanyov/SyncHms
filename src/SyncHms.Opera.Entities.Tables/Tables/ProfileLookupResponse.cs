...
public partial class ProfileLookupResponse
{
	...
	{
		modelBuilder.Entity<ProfileLookupResponse>(entity =>
        {
            entity.HasKey(e => e.ResponseRecId)
                .HasName("PLE_PK");

            entity.ToTable("PROFILE_LOOKUP_RESPONSE");

            entity.HasIndex(e => new { e.RequestId, e.DatabaseId })
                .HasName("PROF_LOOKUP_RESP_IDX1");
