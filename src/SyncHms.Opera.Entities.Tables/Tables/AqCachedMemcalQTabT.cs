...
public partial class AqCachedMemcalQTabT
{
	...
	{
		modelBuilder.Entity<AqCachedMemcalQTabT>(entity =>
        {
            entity.HasKey(e => new { e.NextDate, e.TxnId, e.Msgid })
                .HasName("SYS_IOT_TOP_142095");

            entity.ToTable("AQ$_CACHED$_MEMCAL_Q_TAB_T");
