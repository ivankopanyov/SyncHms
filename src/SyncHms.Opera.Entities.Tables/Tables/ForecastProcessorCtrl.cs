...
public partial class ForecastProcessorCtrl
{
	...
	{
		modelBuilder.Entity<ForecastProcessorCtrl>(entity =>
        {
            entity.HasKey(e => e.FpSeq)
                .HasName("FP_CTRL_PK");

            entity.ToTable("FORECAST_PROCESSOR_CTRL");
