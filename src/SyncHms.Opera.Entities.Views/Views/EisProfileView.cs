...
public partial class EisProfileView
{
	...
	{
		modelBuilder.Entity<EisProfileView>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("EIS_PROFILE_VIEW");
            ...
            entity.Property(e => e.FArNo)
                .HasColumnName("F_AR_NO")
                .IsUnicode(false);
            ...
            entity.Property(e => e.FFaxId)
                .HasColumnName("F_FAX_ID")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.FMemberId)
                .HasColumnName("F_MEMBER_ID")
                .IsUnicode(false);

            entity.Property(e => e.FMemberLevel)
                .HasColumnName("F_MEMBER_LEVEL")
                .IsUnicode(false);

            entity.Property(e => e.FMemberNo)
                .HasColumnName("F_MEMBER_NO")
                .IsUnicode(false);

            entity.Property(e => e.FMemberType)
                .HasColumnName("F_MEMBER_TYPE")
                .IsUnicode(false);
            ...
            entity.Property(e => e.FNameKeywords)
                .HasColumnName("F_NAME_KEYWORDS")
                .IsUnicode(false);

            entity.Property(e => e.FPhoneId)
                .HasColumnName("F_PHONE_ID")
                .HasColumnType("NUMBER");

            entity.Property(e => e.FPhoneNo)
                .HasColumnName("F_PHONE_NO")
                .IsUnicode(false);

            entity.Property(e => e.FTitleName)
                .HasColumnName("F_TITLE_NAME")
                .IsUnicode(false);

            entity.Property(e => e.FVipName)
                .HasColumnName("F_VIP_NAME")
                .IsUnicode(false);
            ...
            entity.Property(e => e.IataCompNo)
                .HasColumnName("IATA_COMP_NO")
                .HasMaxLength(20)
                .IsUnicode(false);
