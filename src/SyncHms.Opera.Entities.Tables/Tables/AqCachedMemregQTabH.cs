...
public partial class AqCachedMemregQTabH
{
	...
	{
		modelBuilder.Entity<AqCachedMemregQTabH>(entity =>
        {
            entity.HasKey(e => new { e.Msgid, e.Subscriber, e.Name, e.Address })
                .HasName("SYS_IOT_TOP_165788");

            entity.ToTable("AQ$_CACHED$_MEMREG_Q_TAB_H");
