...
public partial class TrxReasonCodes
{
	...
	{
		modelBuilder.Entity<TrxReasonCodes>(entity =>
        {
            entity.HasKey(e => new { e.TranReasonCode, e.Resort })
                .HasName("TRX$_REASON_CODES_PK");

            entity.ToTable("TRX$_REASON_CODES");
