...
public partial class BusinessProfileForecastDtls1
{
	...
	{
		modelBuilder.Entity<BusinessProfileForecastDtls1>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("BUSINESS_PROFILE_FORECAST_DTLS");

            entity.Property(e => e.FbRevenue)
                .HasColumnName("FB_REVENUE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.ForecastSplitDesc)
                .HasColumnName("FORECAST_SPLIT_DESC")
                .IsUnicode(false);
