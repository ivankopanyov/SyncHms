...
public partial class NightAuditProcedures
{
    ...
    public string? BackupActiveYn { get; set; }
	...
	{
		modelBuilder.Entity<NightAuditProcedures>(entity =>
        {
            entity.HasKey(e => e.NaId)
                .HasName("NAP_PK");

            entity.ToTable("NIGHT_AUDIT$_PROCEDURES");

            entity.HasIndex(e => e.ModuleId)
                .HasName("NA_APP_FK_I");

            entity.HasIndex(e => e.Resort)
                .HasName("NAP_RES_FK_I");
            ...
            entity.Property(e => e.BackupActiveYn)
                .HasColumnName("BACKUP_ACTIVE_YN")
                .HasMaxLength(1)
                .IsUnicode(false);
			...
			if (!types.Contains(typeof(AppModules)))
	            ...
	            entity.HasOne(d => d.Module)
	                .WithMany(p => p.NightAuditProcedures)
	                .HasForeignKey(d => d.ModuleId)
	                .HasConstraintName("NA_APP_FK");
