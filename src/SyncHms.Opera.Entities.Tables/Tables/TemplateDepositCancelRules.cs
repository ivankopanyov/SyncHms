...
public partial class TemplateDepositCancelRules
{
	...
	{
		modelBuilder.Entity<TemplateDepositCancelRules>(entity =>
        {
            entity.HasKey(e => new { e.ChainCode, e.RuleType, e.RuleCode })
                .HasName("TEMP_DCRULES_PK");

            entity.ToTable("TEMPLATE_DEPOSIT_CANCEL_RULES");
