...
public partial class ObiScLeadsDim
{
	...
	{
		modelBuilder.Entity<ObiScLeadsDim>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("OBI_SC_LEADS_DIM");
            ...
            entity.Property(e => e.Booklink).HasColumnName("BOOKLINK");
            ...
            entity.Property(e => e.ReplBy)
                .HasColumnName("REPL_BY")
                .HasColumnType("NUMBER");

            entity.Property(e => e.ReplByName)
                .HasColumnName("REPL_BY_NAME")
                .IsUnicode(false);

            entity.Property(e => e.ReplDate)
                .HasColumnName("REPL_DATE")
                .HasColumnType("DATE");

            entity.Property(e => e.ReplVia)
                .HasColumnName("REPL_VIA")
                .HasMaxLength(10)
                .IsUnicode(false);
