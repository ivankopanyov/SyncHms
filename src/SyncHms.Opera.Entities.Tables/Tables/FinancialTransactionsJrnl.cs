...
public partial class FinancialTransactionsJrnl
{
    ...
    public decimal? FinDmlSeqNo1 { get; set; }
	...
	{
		modelBuilder.Entity<FinancialTransactionsJrnl>(entity =>
        {
            entity.HasNoKey();

            entity.ToTable("FINANCIAL_TRANSACTIONS_JRNL");

            entity.HasIndex(e => e.ActionId)
                .HasName("FINTJ_BE_ACTION_ID");

            entity.HasIndex(e => e.CashierId)
                .HasName("FINTJ_CSR_FK_I");

            entity.HasIndex(e => e.MarketCode)
                .HasName("FINTJ_MARKET_CODE_IND");

            entity.HasIndex(e => e.NameId)
                .HasName("FINTJ_NAME_ID_I");

            entity.HasIndex(e => e.OldTranActionId)
                .HasName("FINTJ_OLD_TRAN1");

            entity.HasIndex(e => e.ResvNameId)
                .HasName("FINTJ_RESV_NAME_ID_I");

            entity.HasIndex(e => e.TranActionId)
                .HasName("FINTJ_ACTION_ID");

            entity.HasIndex(e => e.TrxNo)
                .HasName("FINTJ_TRX_NO");

            entity.HasIndex(e => new { e.Resort, e.Room })
                .HasName("FINTJ_ROOM_I");

            entity.HasIndex(e => new { e.Resort, e.TrxCode, e.TrxDate })
                .HasName("FINTJ_TRX_CODE");

            entity.HasIndex(e => new { e.TcGroup, e.TcSubgroup, e.TrxCode })
                .HasName("FINTJ_TC_FK_I");

            entity.HasIndex(e => new { e.Resort, e.ArNumber, e.ArState, e.NameId })
                .HasName("FINTJ_AR_DET_I");
            ...
            entity.Property(e => e.FinDmlSeqNo1)
                .HasColumnName("FIN_DML_SEQ_NO")
                .HasColumnType("NUMBER");

            entity.Property(e => e.FinDmlSeqno)
                .HasColumnName("FIN_DML_SEQNO")
                .HasColumnType("NUMBER");
			...
			if (!types.Contains(typeof(Name)))
	            ...
	            entity.HasOne(d => d.Name)
	                ...
	                .HasConstraintName("JFINT_NAME_ID");
			...
			if (!types.Contains(typeof(Resort)))
	            ...
	            entity.HasOne(d => d.ResortNavigation)
	                ...
	                .HasConstraintName("JFINT_RESORT");
