...
public partial class FolioType
{
	...
	{
		modelBuilder.Entity<FolioType>(entity =>
        {
            entity.HasNoKey();

            entity.ToTable("FOLIO$_TYPE");

            entity.HasIndex(e => new { e.QueueName, e.Resort })
                .HasName("FOLIO_TYPE_QUEUE_NAME");

            entity.HasIndex(e => new { e.Resort, e.FolioType1 })
                .HasName("FOT_UK")
                .IsUnique();
