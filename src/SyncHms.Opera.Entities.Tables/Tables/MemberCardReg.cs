...
public partial class MemberCardReg
{
	...
	{
		modelBuilder.Entity<MemberCardReg>(entity =>
        {
            entity.HasKey(e => e.MemberCardRegCode)
                .HasName("MEMBER_CARD_REG_PK");

            entity.ToTable("MEMBER_CARD_REG");

            entity.HasIndex(e => e.AppUserRegCode)
                .HasName("MEMBER_CARD_REG_IDX02");

            entity.HasIndex(e => e.FeeRecId)
                .HasName("MEMBER_CARD_REG_IDX03");

            entity.HasIndex(e => e.NameId)
                .HasName("MEMBER_CARD_REG_IDX01");

            entity.HasIndex(e => new { e.BatchId, e.ImportDate })
                .HasName("MEMBER_CARD_REG_IDX05");

            entity.HasIndex(e => new { e.ChainCode, e.MembershipType, e.FeeCode })
                .HasName("MEMBER_CARD_REG_IDX04");
