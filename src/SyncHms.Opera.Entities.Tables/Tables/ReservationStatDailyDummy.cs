...
public partial class ReservationStatDailyDummy
{
	...
	{
		modelBuilder.Entity<ReservationStatDailyDummy>(entity =>
        {
            entity.HasNoKey();

            entity.ToTable("RESERVATION_STAT_DAILY_DUMMY");

            entity.HasIndex(e => new { e.Resort, e.BusinessDate, e.ResvNameId })
                .HasName("RESERVATION_STAT_DAILY_DMY_ID1");
