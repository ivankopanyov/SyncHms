...
public partial class DynamicFields
{
    ...
    public decimal? OrgFieldId { get; set; }
	...
	{
		modelBuilder.Entity<DynamicFields>(entity =>
        {
            entity.ToTable("DYNAMIC_FIELDS");

            entity.HasIndex(e => new { e.ChainCode, e.FormName, e.ItemName })
                .HasName("DF_CHAIN_FRM_ITM_I");

            entity.HasIndex(e => new { e.FormMode, e.FormName, e.Status })
                .HasName("DF_MODE_FRM_STAT_I");

            entity.HasIndex(e => new { e.FormName, e.Status, e.FormMode })
                .HasName("DF_FRM_STAT_MODE_I");
            ...
            entity.Property(e => e.OrgFieldId)
                .HasColumnName("ORG_FIELD_ID")
                .HasColumnType("NUMBER");
