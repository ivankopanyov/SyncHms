...
public partial class ExpPromoResortCoupons
{
    ...
    public decimal? PPromoSeqId { get; set; }
    ...
    public decimal? PAuthorizerId { get; set; }
	...
	{
		modelBuilder.Entity<ExpPromoResortCoupons>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("EXP_PROMO_RESORT_COUPONS");
            ...
            entity.Property(e => e.PAuthorizerId)
                .HasColumnName("P_AUTHORIZER_ID")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.PPromoSeqId)
                .HasColumnName("P_PROMO_SEQ_ID")
                .HasColumnType("NUMBER");
