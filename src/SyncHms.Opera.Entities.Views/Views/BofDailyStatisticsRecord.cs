...
public partial class BofDailyStatisticsRecord
{
	...
	{
		modelBuilder.Entity<BofDailyStatisticsRecord>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("BOF_DAILY_STATISTICS_RECORD");
            ...
            entity.Property(e => e.StatAmount)
