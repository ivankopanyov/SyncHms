...
public partial class FolioType1
{
    ...
    public string? GroupfolioName { get; set; }
    ...
    public string? PostitFolioName { get; set; }
	...
	{
		modelBuilder.Entity<FolioType1>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("FOLIO_TYPE");
            ...
            entity.Property(e => e.DirectBillYn)
                .HasColumnName("DIRECT_BILL_YN")
                .HasMaxLength(1)
                .IsUnicode(false);
            ...
            entity.Property(e => e.GroupfolioName)
                .HasColumnName("GROUPFOLIO_NAME")
                .IsUnicode(false);
            ...
            entity.Property(e => e.PostitFolioName)
                .HasColumnName("POSTIT_FOLIO_NAME")
                .IsUnicode(false);
            ...
            entity.Property(e => e.SimpleFolioYn)
                .HasColumnName("SIMPLE_FOLIO_YN")
                .HasMaxLength(1)
                .IsUnicode(false);
            ...
            entity.Property(e => e.WorkingDocsYn)
                .HasColumnName("WORKING_DOCS_YN")
                .HasMaxLength(1)
                .IsUnicode(false);
        });
	}
