...
public partial class MembershipAwardRates
{
	...
	{
		modelBuilder.Entity<MembershipAwardRates>(entity =>
        {
            entity.HasNoKey();

            entity.ToTable("MEMBERSHIP_AWARD_RATES");

            entity.HasIndex(e => new { e.Resort, e.RateCode })
                .HasName("MEMBERSHIP_AWARD_RATES_IND1");

            entity.HasIndex(e => new { e.ChainCode, e.MembershipType, e.AwardType, e.Resort, e.RateCode })
                .HasName("MEMBERSHIP_AWARD_RATES_UK1")
                .IsUnique();
			...
			if (!types.Contains(typeof(MembershipAwards)))
	            ...
	            entity.HasOne(d => d.MembershipAwards)
	                ...
	                .HasConstraintName("MEMBERSHIP_AWARD_RATES_FK");
        });
	}
}
