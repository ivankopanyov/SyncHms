...
public partial class ExpOcrmMemclaims
{
	...
	{
		modelBuilder.Entity<ExpOcrmMemclaims>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("EXP_OCRM_MEMCLAIMS");
            ...
            entity.Property(e => e.ClaimInsDt)
                .HasColumnName("CLAIM_INS_DT")
                .HasColumnType("DATE");

            entity.Property(e => e.ClaimInsUser)
                .HasColumnName("CLAIM_INS_USER")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.ClaimUpdDt)
                .HasColumnName("CLAIM_UPD_DT")
                .HasColumnType("DATE");

            entity.Property(e => e.ClaimUpdUser)
                .HasColumnName("CLAIM_UPD_USER")
                .HasColumnType("NUMBER");
