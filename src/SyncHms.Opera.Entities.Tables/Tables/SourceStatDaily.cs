...
public partial class SourceStatDaily
{
    ...
    public decimal? TotalNonRevenueMtd { get; set; }
    public decimal? TotalNonRevenueTaxMtd { get; set; }
    public decimal? TotalPackageNonRevenueMtd { get; set; }
    ...
    public decimal? AdvTotalFoodTaxMtd { get; set; }
    public decimal? AdvTotalFoodTaxYtd { get; set; }
    public decimal? AdvTotalNonRevenue { get; set; }
    public decimal? AdvTotalNonRevenueMtd { get; set; }
    public decimal? AdvTotalNonRevenueTax { get; set; }
    public decimal? AdvTotalNonRevenueTaxMtd { get; set; }
    public decimal? AdvTotalNonRevenueTaxYtd { get; set; }
    public decimal? AdvTotalNonRevenueYtd { get; set; }
    public decimal? AdvTotalOtherRevenue { get; set; }
    public decimal? AdvTotalOtherRevenueMtd { get; set; }
    public decimal? AdvTotalOtherRevenueYtd { get; set; }
    public decimal? AdvTotalOtherTax { get; set; }
    public decimal? AdvTotalOtherTaxMtd { get; set; }
    public decimal? AdvTotalOtherTaxYtd { get; set; }
    public decimal? AdvTotalRevenue { get; set; }
    public decimal? AdvTotalRevenueMtd { get; set; }
    public decimal? AdvTotalRevenueYtd { get; set; }
    public decimal? AdvTotalRoomRevenue { get; set; }
    public decimal? AdvTotalRoomRevenueMtd { get; set; }
    public decimal? AdvTotalRoomRevenueYtd { get; set; }
    public decimal? AdvTotalRoomTax { get; set; }
    public decimal? AdvTotalRoomTaxMtd { get; set; }
    public decimal? AdvTotalRoomTaxYtd { get; set; }
    public decimal? AdvTotalTax { get; set; }
    public decimal? AdvTotalTaxMtd { get; set; }
    public decimal? AdvTotalTaxYtd { get; set; }

	public static void OnModelCreating(ModelBuilder modelBuilder, ISet<Type> types)
	{
		modelBuilder.Entity<SourceStatDaily>(entity =>
        {
            entity.HasKey(e => new { e.Resort, e.BusinessDate, e.SourceCode, e.RoomType, e.SourceMainGroup })
                .HasName("SOURCE_STAT_DAILY_PK");

            entity.ToTable("SOURCE_STAT_DAILY");

            entity.HasIndex(e => new { e.Resort, e.SourceCode, e.RoomType, e.BusinessDate })
                .HasName("SOURCE_STAT_DAILY_IND1");

            entity.HasIndex(e => new { e.Resort, e.SourceMainGroup, e.RoomType, e.BusinessDate })
                .HasName("SOURCE_STAT_DAILY_IND2");
            ...
            entity.Property(e => e.AdvTotalFoodRevenueMtd)
                .HasColumnName("ADV_TOTAL_FOOD_REVENUE_MTD")
                .HasColumnType("NUMBER");

            entity.Property(e => e.AdvTotalFoodRevenueYtd)
                .HasColumnName("ADV_TOTAL_FOOD_REVENUE_YTD")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.AdvTotalFoodTaxMtd)
                .HasColumnName("ADV_TOTAL_FOOD_TAX_MTD")
                .HasColumnType("NUMBER");

            entity.Property(e => e.AdvTotalFoodTaxYtd)
                .HasColumnName("ADV_TOTAL_FOOD_TAX_YTD")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.AdvTotalNonRevenueMtd)
                .HasColumnName("ADV_TOTAL_NON_REVENUE_MTD")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.AdvTotalNonRevenueTaxMtd)
                .HasColumnName("ADV_TOTAL_NON_REVENUE_TAX_MTD")
                .HasColumnType("NUMBER");

            entity.Property(e => e.AdvTotalNonRevenueTaxYtd)
                .HasColumnName("ADV_TOTAL_NON_REVENUE_TAX_YTD")
                .HasColumnType("NUMBER");

            entity.Property(e => e.AdvTotalNonRevenueYtd)
                .HasColumnName("ADV_TOTAL_NON_REVENUE_YTD")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.AdvTotalOtherRevenueMtd)
                .HasColumnName("ADV_TOTAL_OTHER_REVENUE_MTD")
                .HasColumnType("NUMBER");

            entity.Property(e => e.AdvTotalOtherRevenueYtd)
                .HasColumnName("ADV_TOTAL_OTHER_REVENUE_YTD")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.AdvTotalOtherTaxMtd)
                .HasColumnName("ADV_TOTAL_OTHER_TAX_MTD")
                .HasColumnType("NUMBER");

            entity.Property(e => e.AdvTotalOtherTaxYtd)
                .HasColumnName("ADV_TOTAL_OTHER_TAX_YTD")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.AdvTotalRevenueMtd)
                .HasColumnName("ADV_TOTAL_REVENUE_MTD")
                .HasColumnType("NUMBER");

            entity.Property(e => e.AdvTotalRevenueYtd)
                .HasColumnName("ADV_TOTAL_REVENUE_YTD")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.AdvTotalRoomRevenueMtd)
                .HasColumnName("ADV_TOTAL_ROOM_REVENUE_MTD")
                .HasColumnType("NUMBER");

            entity.Property(e => e.AdvTotalRoomRevenueYtd)
                .HasColumnName("ADV_TOTAL_ROOM_REVENUE_YTD")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.AdvTotalRoomTaxMtd)
                .HasColumnName("ADV_TOTAL_ROOM_TAX_MTD")
                .HasColumnType("NUMBER");

            entity.Property(e => e.AdvTotalRoomTaxYtd)
                .HasColumnName("ADV_TOTAL_ROOM_TAX_YTD")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.AdvTotalTaxMtd)
                .HasColumnName("ADV_TOTAL_TAX_MTD")
                .HasColumnType("NUMBER");

            entity.Property(e => e.AdvTotalTaxYtd)
                .HasColumnName("ADV_TOTAL_TAX_YTD")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.NoOfDefiniteRooms)
                .HasColumnName("NO_OF_DEFINITE_ROOMS")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.RowMigratedFromV6Yn)
                .HasColumnName("ROW_MIGRATED_FROM_V6_YN")
                .HasMaxLength(1)
                .IsUnicode(false);
            ...
            entity.Property(e => e.TotalNonRevenueMtd)
                .HasColumnName("TOTAL_NON_REVENUE_MTD")
                .HasColumnType("NUMBER(38,12)");
            ...
            entity.Property(e => e.TotalNonRevenueTaxMtd)
                .HasColumnName("TOTAL_NON_REVENUE_TAX_MTD")
                .HasColumnType("NUMBER(38,12)");

            entity.Property(e => e.TotalNonRevenueTaxYtd)
                .HasColumnName("TOTAL_NON_REVENUE_TAX_YTD")
                .HasColumnType("NUMBER(38,12)");

            entity.Property(e => e.TotalNonRevenueYtd)
                .HasColumnName("TOTAL_NON_REVENUE_YTD")
                .HasColumnType("NUMBER(38,12)");
            ...
            entity.Property(e => e.TotalPackageNonRevenueMtd)
                .HasColumnName("TOTAL_PACKAGE_NON_REVENUE_MTD")
                .HasColumnType("NUMBER(38,12)");

            entity.Property(e => e.TotalPackageNonRevenueYtd)
                .HasColumnName("TOTAL_PACKAGE_NON_REVENUE_YTD")
                .HasColumnType("NUMBER(38,12)");
