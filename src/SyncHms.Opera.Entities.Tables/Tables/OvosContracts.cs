...
public partial class OvosContracts
{
    public OvosContracts()
    {
        OvosContractDoc = new HashSet<OvosContractDoc>();
        OvosContractElements = new HashSet<OvosContractElements>();
        OvosContractFees = new HashSet<OvosContractFees>();
        OvosContractInsurance = new HashSet<OvosContractInsurance>();
        OvosContractTasks = new HashSet<OvosContractTasks>();
        OvosContractsSubscriptions = new HashSet<OvosContractsSubscriptions>();
        OvosFractionalOwnersUsers = new HashSet<OvosFractionalOwnersUsers>();
        OvosOwnersUsers = new HashSet<OvosOwnersUsers>();
        OvosReciprocalOwners = new HashSet<OvosReciprocalOwners>();
        OvosRestrictionRanges = new HashSet<OvosRestrictionRanges>();
    }
    ...
    public virtual ICollection<OvosContractDoc> OvosContractDoc { get; set; }
    public virtual ICollection<OvosContractElements> OvosContractElements { get; set; }
    public virtual ICollection<OvosContractFees> OvosContractFees { get; set; }
    public virtual ICollection<OvosContractInsurance> OvosContractInsurance { get; set; }
    public virtual ICollection<OvosContractTasks> OvosContractTasks { get; set; }
    public virtual ICollection<OvosContractsSubscriptions> OvosContractsSubscriptions { get; set; }
    public virtual ICollection<OvosFractionalOwnersUsers> OvosFractionalOwnersUsers { get; set; }
    public virtual ICollection<OvosOwnersUsers> OvosOwnersUsers { get; set; }
    public virtual ICollection<OvosReciprocalOwners> OvosReciprocalOwners { get; set; }
    public virtual ICollection<OvosRestrictionRanges> OvosRestrictionRanges { get; set; }

	public static void OnModelCreating(ModelBuilder modelBuilder, ISet<Type> types)
	{
		modelBuilder.Entity<OvosContracts>(entity =>
        {
            entity.HasKey(e => new { e.Resort, e.ContractId })
                .HasName("OVOS_CONTRACTS_PK");

            entity.ToTable("OVOS_CONTRACTS");

            entity.HasIndex(e => e.ContractId)
                .HasName("OVOS_CONTRACTS_UK")
                .IsUnique();

            entity.HasIndex(e => new { e.Resort, e.ContractNumber })
                .HasName("OVOS_CONTRACTS_IDX3");

            entity.HasIndex(e => new { e.Resort, e.Status, e.BeginDate })
                .HasName("OVOS_CONTRACTS_IDX1");

            entity.HasIndex(e => new { e.Resort, e.Unit, e.BeginDate, e.EndDate })
                .HasName("OVOS_CONTRACTS_IDX2");
			...
			if (!types.Contains(typeof(Resort)))
	            ...
	            entity.HasOne(d => d.ResortNavigation)
	                .WithMany(p => p.OvosContracts)
	                .HasForeignKey(d => d.Resort)
	                .OnDelete(DeleteBehavior.ClientSetNull)
	                .HasConstraintName("OVOS_CONTRACTS_RESORT_FK");
        
			if (!types.Contains(typeof(OvosContractDoc)))
				entity.Ignore(e => e.OvosContractDoc);

			if (!types.Contains(typeof(OvosContractElements)))
				entity.Ignore(e => e.OvosContractElements);

			if (!types.Contains(typeof(OvosContractFees)))
				entity.Ignore(e => e.OvosContractFees);

			if (!types.Contains(typeof(OvosContractInsurance)))
				entity.Ignore(e => e.OvosContractInsurance);

			if (!types.Contains(typeof(OvosContractTasks)))
				entity.Ignore(e => e.OvosContractTasks);

			if (!types.Contains(typeof(OvosContractsSubscriptions)))
				entity.Ignore(e => e.OvosContractsSubscriptions);

			if (!types.Contains(typeof(OvosFractionalOwnersUsers)))
				entity.Ignore(e => e.OvosFractionalOwnersUsers);

			if (!types.Contains(typeof(OvosOwnersUsers)))
				entity.Ignore(e => e.OvosOwnersUsers);

			if (!types.Contains(typeof(OvosReciprocalOwners)))
				entity.Ignore(e => e.OvosReciprocalOwners);

			if (!types.Contains(typeof(OvosRestrictionRanges)))
				entity.Ignore(e => e.OvosRestrictionRanges);
		});
	}
}
