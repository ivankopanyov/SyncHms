...
public partial class ExpMembershipExtracts
{
    ...
    public string? Printcardname { get; set; }
    ...
    public string? MemExcludeBatch { get; set; }

	public static void OnModelCreating(ModelBuilder modelBuilder, ISet<Type> types)
	{
		modelBuilder.Entity<ExpMembershipExtracts>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("EXP_MEMBERSHIP_EXTRACTS");
            ...
            entity.Property(e => e.Gcstatus)
                .HasColumnName("GCSTATUS")
                .HasMaxLength(20)
                .IsUnicode(false);
            ...
            entity.Property(e => e.MemExcludeBatch)
                .HasColumnName("MEM_EXCLUDE_BATCH")
                .HasMaxLength(1)
                .IsUnicode(false);
            ...
            entity.Property(e => e.Printcardname)
                .IsRequired()
                .HasColumnName("PRINTCARDNAME")
                .HasMaxLength(80)
                .IsUnicode(false);
