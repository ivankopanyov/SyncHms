...
public partial class DynamicFieldsSid
{
	...
	{
		modelBuilder.Entity<DynamicFieldsSid>(entity =>
        {
            entity.HasNoKey();

            entity.ToTable("DYNAMIC_FIELDS_SID");

            entity.HasIndex(e => new { e.FormName, e.BlockName, e.ItemName, e.Resort, e.FormMode })
                .HasName("DYNAMIC_FIELDS_SID_UK")
                .IsUnique();
