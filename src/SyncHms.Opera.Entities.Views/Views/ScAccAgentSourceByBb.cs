...
public partial class ScAccAgentSourceByBb
{
    ...
    public string? AccSrepId { get; set; }
    public string? AccSrepName { get; set; }
    public string? AccAddressType { get; set; }

	public static void OnModelCreating(ModelBuilder modelBuilder, ISet<Type> types)
	{
		modelBuilder.Entity<ScAccAgentSourceByBb>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("SC_ACC_AGENT_SOURCE_BY_BB");
            ...
            entity.Property(e => e.AccSrepId)
                .HasColumnName("ACC_SREP_ID")
                .IsUnicode(false);

            entity.Property(e => e.AccSrepName)
                .HasColumnName("ACC_SREP_NAME")
                .IsUnicode(false);
