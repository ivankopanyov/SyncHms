...
public partial class OperaEcertsVw
{
    ...
    public string? ComputedScope { get; set; }
	...
	{
		modelBuilder.Entity<OperaEcertsVw>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("OPERA_ECERTS_VW");
            ...
            entity.Property(e => e.ComputedScope)
                .HasColumnName("COMPUTED_SCOPE")
                .HasMaxLength(1)
                .IsUnicode(false);
