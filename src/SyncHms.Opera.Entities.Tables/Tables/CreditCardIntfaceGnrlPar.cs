...
public partial class CreditCardIntfaceGnrlPar
{
    public CreditCardIntfaceGnrlPar()
    {
        CreditCardInterfaceSetups = new HashSet<CreditCardInterfaceSetups>();
    }
    ...
    public string? InstallmentsActiveYn { get; set; }
    public decimal? MaxInstallments { get; set; }
    public string? StoreOfflineSettlementsYn { get; set; }
    public decimal? AuthorizationValidForDays { get; set; }

    public virtual ICollection<CreditCardInterfaceSetups> CreditCardInterfaceSetups { get; set; }

	public static void OnModelCreating(ModelBuilder modelBuilder, ISet<Type> types)
	{
		modelBuilder.Entity<CreditCardIntfaceGnrlPar>(entity =>
        {
            entity.HasKey(e => e.Resort)
                .HasName("CCIGP_PK");

            entity.ToTable("CREDIT_CARD_INTFACE_GNRL_PAR");
            ...
            entity.Property(e => e.InstallmentsActiveYn)
                .HasColumnName("INSTALLMENTS_ACTIVE_YN")
                .HasMaxLength(1)
                .IsUnicode(false);
            ...
            entity.Property(e => e.StoreOfflineSettlementsYn)
                .HasColumnName("STORE_OFFLINE_SETTLEMENTS_YN")
                .HasMaxLength(1)
                .IsUnicode(false);
			...
			if (!types.Contains(typeof(CreditCardInterfaceSetups)))
				entity.Ignore(e => e.CreditCardInterfaceSetups);
		});
	}
}
