...
public partial class ProfileCompanyReservations
{
    ...
    public decimal? TotalRevenueRes { get; set; }
    public decimal? RoomRevenueRes { get; set; }
    public decimal? FbRevenueRes { get; set; }
    public decimal? OtherRevenueRes { get; set; }
    public decimal? NoOfRooms1 { get; set; }
    ...
    public decimal? NameIdProf { get; set; }
    public string? NameTypeProf { get; set; }
	...
	{
		modelBuilder.Entity<ProfileCompanyReservations>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("PROFILE_COMPANY_RESERVATIONS");
            ...
            entity.Property(e => e.FbRevenueRes)
                .HasColumnName("FB_REVENUE_RES")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.NameIdProf)
                .HasColumnName("NAME_ID_PROF")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.NameTypeProf)
                .IsRequired()
                .HasColumnName("NAME_TYPE_PROF")
                .HasMaxLength(20)
                .IsUnicode(false);
            ...
            entity.Property(e => e.NoOfRooms1)
            ...
            entity.Property(e => e.OtherRevenueRes)
                .HasColumnName("OTHER_REVENUE_RES")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.RateAmt)
                .HasColumnName("RATE_AMT")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.RoomRevenueRes)
                .HasColumnName("ROOM_REVENUE_RES")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.TotalRevenueRes)
                .HasColumnName("TOTAL_REVENUE_RES")
                .HasColumnType("NUMBER");
